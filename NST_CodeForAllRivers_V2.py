    ...
    if t == dt * pulse_time:  
      ...
      #  print ("# First pulse time")
       ...
       # total_num_added_pulse_parcels = total_num_initial_pulse_parcels
        ...
        print("On this timestep the total number of pulse parcels added = ", total_num_initial_pulse_parcels)
        
        print('total_num_added_pulse_parcels =', total_num_initial_pulse_parcels)
